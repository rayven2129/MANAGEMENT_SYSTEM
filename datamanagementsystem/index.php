...
$conn = mysqli_connect("localhost","root","");
  		if (!$conn) {
  			...
  			$createDatabase =  "CREATE DATABASE IF NOT EXISTS client_database";
  			if (mysqli_query($conn,$createDatabase)) {
  				$createTable = "CREATE TABLE `client_database`.`client_sample_tables` (`id` INT(255) NOT NULL AUTO_INCREMENT PRIMARY KEY, `last_name` VARCHAR(255) NOT NULL, `first_name` VARCHAR(255) NOT NULL, `age` INT(255) NOT NULL, `contact_no` VARCHAR(255) NOT NULL, `gender` VARCHAR(255) NOT NULL) ENGINE = InnoDB;";
		...
		<div class="row">
			...
			<form action="search.php" method="POST">
					<div class="input-group mb-3">
						<input type="search" name="bar_no" class="form-control" placeholder="Search Data by ID---">
			...
			<iframe src="data.php" width="650" height="500" oncontextmenu="return false;"></iframe>
			<div class="input-group-append">
				...
				<button type="button" onclick="window.open('importcsv.php','','width=500; height=500');" class="btn btn-primary button-design input-group-text" title="Export Data to Excel"><i class="fas fa-upload"></i>Upload Excel File</button>
